...
namespace EmotionCaptureApp
{
    ...
    /// </summary>
    public sealed partial class EmotionCapturePage : Page
    {
        ...
        private async void Application_Suspending(object sender, SuspendingEventArgs e)
        {
            ...
            if (Frame.CurrentSourcePageType == typeof(EmotionCapturePage))
            {
        ...
        private async void SystemMediaControls_PropertyChanged(SystemMediaTransportControls sender, SystemMediaTransportControlsPropertyChangedEventArgs args)
        {
            await Dispatcher.RunAsync(CoreDispatcherPriority.Normal, async () =>
            {
                ...
                if (args.Property == SystemMediaTransportControlsProperty.SoundLevel && Frame.CurrentSourcePageType == typeof(EmotionCapturePage))
                {
        ...
        private async Task TakePhotoAsync()
        {
            ...
            try
            {
                ...
                await ReencodeAndSavePhotoAsync(stream, photoOrientation, fileName);

                Frame.Navigate(typeof(FaceRecognizerPage), fileName);
            }
            catch (Exception ex)
            {
